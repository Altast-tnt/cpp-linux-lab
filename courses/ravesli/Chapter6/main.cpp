...
//    int a = 123;
//    int *ptr = &a;
//    std::cout << &a << " is " << a << " also is " << *&a << '\n';
//    std::cout << "ptr is " << ptr << " and a`s address is " << &a << " and ptr value * is " << *ptr;


//    int massive[] = {7, 5, 6, 4, 9, 8, 2, 1, 3};
//    const int massiveLength = sizeof(massive) / sizeof(massive[0]);
//    bubbleSortMassive(massive, massiveLength);

//    sortMassive(massive, massiveLength);
